RSpec.describe Mutest::Matcher::Methods::Instance, '#call' do
  ...
  let(:subject_c) { instance_double(Mutest::Subject) }
  ...
  before do
    {
      ...
      expect(Mutest::Matcher::Method::Instance).to receive(:new)
