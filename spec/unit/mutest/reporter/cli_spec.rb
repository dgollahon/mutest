RSpec.describe Mutest::Reporter::CLI do
  ...
  describe '#progress' do
    ...
    context 'on framed format' do
      ...
      it_reports(<<-REPORT)
        [tput-restore]Mutest configuration:
        Matcher:         #<Mutest::Matcher::Config empty>
        Integration:     Mutest::Integration::Null
        Jobs:            1
        Includes:        []
    ...
    context 'on progressive format' do
      ...
      context 'with empty scheduler' do
        ...
        it_reports Mutest::Color::GREEN.format('(00/02) 100% - killtime: 0.00s runtime: 4.00s overhead: 4.00s') << "\n"
      end
